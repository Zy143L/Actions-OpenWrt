...
# CONFIG_TARGET_ipq40xx_DEVICE_asus_rt-ac1300uhp is not set
...
# CONFIG_TARGET_ipq40xx_DEVICE_p2w_r619ac-pcie is not set
...
CONFIG_LINUX_4_14=y
CONFIG_DEFAULT_ath10k-firmware-qca4019=y
...
CONFIG_DEFAULT_shadowsocks-libev-ss-redir=y
CONFIG_DEFAULT_shadowsocksr-libev-server=y
CONFIG_DEFAULT_swconfig=y
CONFIG_DEFAULT_uci=y
CONFIG_DEFAULT_uclient-fetch=y
CONFIG_DEFAULT_urandom-seed=y
CONFIG_DEFAULT_urngd=y
CONFIG_DEFAULT_v2ray=y
...
# CONFIG_PACKAGE_ipq-wifi-hugo_ac1200 is not set
...
# CONFIG_PACKAGE_kmod-ipt-bandwidth is not set
# CONFIG_PACKAGE_kmod-ipt-cgroup is not set
...
# CONFIG_PACKAGE_kmod-ipt-ndpi is not set
...
# CONFIG_PACKAGE_kmod-ipt-timerange is not set
# CONFIG_PACKAGE_kmod-ipt-tproxy is not set
# CONFIG_PACKAGE_kmod-ipt-u32 is not set
# CONFIG_PACKAGE_kmod-ipt-ulog is not set
# CONFIG_PACKAGE_kmod-ipt-webmon is not set
# CONFIG_PACKAGE_kmod-ipt-weburl is not set
...
# CONFIG_PACKAGE_kmod-sched-cake-oot is not set
...
# CONFIG_PACKAGE_kmod-sched-police is not set
...
# CONFIG_PACKAGE_kmod-usb-phy-qcom-dwc3 is not set
...
# CONFIG_PACKAGE_node-red-admin is not set
...
# CONFIG_PACKAGE_httplib is not set
...
# CONFIG_PACKAGE_libduktape is not set
...
# CONFIG_PACKAGE_libericstools is not set
...
# CONFIG_PACKAGE_libmsgpack-c is not set
...
# CONFIG_PACKAGE_spdlog is not set
...
# CONFIG_PACKAGE_luci-app-xunlei is not set
...
# CONFIG_PACKAGE_webdav-hacdias is not set
...
# CONFIG_PACKAGE_iptables-mod-bandwidth is not set
# CONFIG_PACKAGE_iptables-mod-cgroup is not set
...
# CONFIG_PACKAGE_iptables-mod-ndpi is not set
...
# CONFIG_PACKAGE_iptables-mod-timerange is not set
...
# CONFIG_PACKAGE_iptables-mod-webmon is not set
# CONFIG_PACKAGE_iptables-mod-weburl is not set
...
# CONFIG_PACKAGE_openvpn-easy-rsa-whisky is not set
...
# CONFIG_PACKAGE_dnscrypt-proxy-full is not set
...
# CONFIG_PACKAGE_gargoyle-firewall-util is not set
...
# CONFIG_PACKAGE_libiptbwctl is not set
...
# CONFIG_PACKAGE_openwrt_chinadns is not set
...
# CONFIG_PACKAGE_pdnsd-full is not set
...
# CONFIG_PACKAGE_qos-gargoyle is not set
...
# CONFIG_PACKAGE_duktape is not set
